...
| Member role              | - Manage organizations (Create/Modify organizations / Manage organization members / Manage organization services /Manage billing)<br>- Create projects<br>- Delete projects | - Use organization services                                 | - Organization operation/management roles (organization management, billing, etc.) cannot be granted<br>- System service account<br>&nbsp;&nbsp;- Use roles predefined by NHN Cloud for each service (cannot be changed)<br>- User service account<br>&nbsp;&nbsp;- Customers directly select and assign the required roles |
