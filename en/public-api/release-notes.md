...
## NHN Cloud > Public API > Release Notes { #nhn-cloud-public-api-release-notes }
...
- Provided a public API for querying the organization IAM account password policy
...
<a id="oct-29-2024-added-features"></a>
#### Added Features
