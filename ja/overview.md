...
### 多様なサービス構成 { #composed-of-various-services }
...
### プラットフォーム中心クラウド { #platform-oriented-cloud }
...
### 強力な技術サポート { #powerful-technology-support }
...
| Monitoring | 仮想サーバーをはじめとするNHN Cloud内のリソースに関する指標を収集・提供し、Webサービスの障害有無をモニタリングできます。|
...
| Data & Analytics | データ分析および収集に必要なプラットフォームを使用できます。 |
| Dev Tools | 便利で効率的な開発環境を提供するサービスです。 |
| Management | 最高の技術力を持つ専門エンジニアが体系的にサーバーを管理し、顧客はコンテンツ開発に集中できます。 |
| Bill | 簡単に税金計算書を発行できます。 |
| Collaboration | コラボレボレーションのための便利なサービス。メール、タスクトラッカー、スケジュール管理、チャットまでサポートし、スムーズな協業が可能です。|
...
## サービスリリースポリシー { #service-release-policy }
