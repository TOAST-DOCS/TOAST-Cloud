...
|トラフィックミラーリングフィルタグループ | プロジェクトごと | 10個 | 
...
| NAS ボリューム | プロジェクトごと| 100個 |
| NAS ボリュームサイズ | プロジェクトごと | 30TB |
| NASボリューム当たりの最大サイズ | Volumeごと  | 10TB |
| NAS volume Subnet | プロジェクトごと | 3個 |
| トランジットハブ | プロジェクトごと | 10個 |
| トランジットハブ接続 | プロジェクトごと | 20個 |
| トランジットハブ許可リスト | プロジェクトごと | 10個 |
| トランジットハブルーティングテーブル | プロジェクトごと | 20個 |
| トランジットハブルーティング接続 | プロジェクトごと | 制限なし |
| トランジットハブルーティング配信	 | プロジェクトごと | 制限なし |
| トランジットハブルーティングルール | プロジェクトごと | 100個 |
| トランジットハブマルチキャストドメイン | プロジェクトごと | 20個 |
| トランジットハブマルチキャスト接続 | プロジェクトごと | 制限なし |
| トランジットハブマルチキャストグループ | プロジェクトごと | 100個 |
...
|リソース | 提供基準 | 提供量 | 
|----|----|----|
| ワークロード	| プロジェクトごと |制限なし|
| 作業 | ワークロードごと | 100個 | 
| テンプレート | プロジェクトごと | 1,000個 | 
| コンテナ | テンプレートごと | 10個 |
| CPU | テンプレートごと | 16vCore | 
| CPU | プロジェクトごと | 24vCore | 
| メモリ | テンプレートごと |32,768 MiB |
| メモリ | プロジェクトごと |	49,152 MiB |
| GPU | テンプレートごと |  7Core | 
| GPU | プロジェクトごと | 7Core |
