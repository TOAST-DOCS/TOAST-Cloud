...
| 分類 | サービス名 | グローバル/リージョンサービス | 韓国(パンギョ)リージョン | 韓国(ピョンチョン)リージョン | 韓国(光州)リージョン | 日本(東京)リージョン | 
| --- | ---- | :--------: | :-------: | :-------: | :-------: | :----------: |
| Compute | Instance | リージョン | O | O | O | O | 
|  | Ephemeral Storage Instance | リージョン | | | | O |  
|  | GPU Instance | リージョン | O |  | O |  | 
|  | Instance Template | リージョン | O | O | O | O |
|  | Image | リージョン | O | O | O | O | O |
|  | Image Builder  | リージョン | O | O | O | |  
|  | Auto Scale | リージョン | O | O | O | O | 
|  | Virtual Desktop | リージョン | O | O |  |  | 
|  | Cloud Functions | リージョン | O |  |  |  | 
| Container | NHN Kubernetes Service(NKS) | リージョン | O | O | O |  |  
|  | NHN Container Registry (NCR) | リージョン | O | O | O |  |  
|  | NHN Container Service(NCS)  | リージョン | O |  | O |  |  
| Network | VPC | リージョン | O | O | O | O |
|  | NAT Instance | リージョン | O | O | O |  |  
|  | Floating IP | リージョン | O | O | O | O | 
|  | Security Groups | リージョン | O | O | O | O |
|  | Network ACL | リージョン | O | O | O | |  
...
|  | Colocation Gateway | リージョン | O | O | O |  | 
|  | NAT Gateway | リージョン | O | O | O |  | 
|  | VPN Gateway(Site-to-Site VPN) | リージョン | O | O | O |  | 
|  | Service Gateway | リージョン | O | O | O |  |  
|  | Traffic Mirroring | リージョン | O | O | O | | 
|  | Private DNS | リージョン | O | O | O | | 
|  | DNS Plus | グローバル |  |  |  |  |
|  | Direct Connect | リージョン | O | O | O |  | 
...
|  | Security Monitoring | リージョン | O | O | O |  | 
|  | Basic Security | リージョン | O | O |  |  | 
|  | CAPTCHA | リージョン | O |  |  |  |  | 
|  | Web Firewall | リージョン | O | O | O | | 
|  | Vaccine | リージョン | O | O |  |  | 
...
|  | RTCS | グローバル |  |  |  |  | 
|  | ShortURL | グローバル |  |  |  |  | 
|  | JEUS Instance | リージョン | O | O |  | O | 
|  | WebtoB Instance | リージョン | O | O |  | O | 
