...
| メンバーロール | - 組織管理(組織作成/修正/組織メンバー管理/組織サービス管理/決済管理)<br>- プロジェクト作成<br>- プロジェクト削除 | - 組織サービス利用 | - 組織運営・管理のロール(組織管理、決済など)は付与不可<br>- システムサービスアカウント<br>&nbsp;&nbsp;- NHN Cloudがサービス別に事前定義したロールを使用(変更不可)<br>- ユーザーサービスアカウント<br>&nbsp;&nbsp;- お客様が必要なロールを直接選択・付与 |
