...
![tutorial_2_ko.png](http://static.toastoven.net/toast/console_guide/consoleguide_02_202107.png)
...
* 서비스 설정
    ...
    * 서비스 별 설정 : 각 서비스(Cloud, Dooray! 등) 별로 IP ACL을 설정할 수 있습니다.
* IP ACL 설정
...
* 모든 조직 서비스(콘솔, Dooray! 등)에 동일하게 설정하거나, 각 서비스별로 다르게 설정할 수 있습니다.

![iam_console_login_security_setting_guide_1_ko.png](http://static.toastoven.net/toast/console_guide/consoleguide_09_202107.png)
...
* 서비스 설정
    ...
    * 서비스 별 설정 : 각 서비스(Cloud Console, Dooray! 등) 별로 2차 인증을 다르게 설정할 수 있습니다.
* 2차 인증 설정
...
* 조직 서비스별(Dooray!, CloudTrail 등) 설정할 수 있는 권한이 다릅니다.
