...
콘솔 접속 및 User Access Key 토큰 인증 방식의 Public API 호출 시 IP ACL이 적용됩니다. [인증 방식 지원 현황 보기](/Support-Status/ko/supported-authentication-methods/)
...
### NHN Cloud 계정 / IAM 계정 정책 { #policy-for-nhn-cloud-members-iam-members-and-service-accounts }
...
알림 관리 기능은 NHN Cloud에서 발송하는 알림별로 고객이 직접 수신할 대상자와 알림 방법(Email, SMS, 웹훅)을 설정할 수 있는 기능입니다.
...
- 사용자 정의 웹훅
    ...
    - 웹훅 이름
        - 설정할 사용자 정의 웹훅의 이름을 최대 40자로 입력할 수 있습니다.
        * 같은 알림 수신 그룹 내 웹훅 이름은 중복될 수 없습니다.
    * 서비스
