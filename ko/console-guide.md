...
설정된 권한 그룹은 프로젝트의 권한 그룹 관리에서 NHN Cloud 회원 및 IAM 회원을 선택해 권한을 일괄 부여할 수 있습니다.
...
| Vehicle Plate Recognizer | ADMIN | AI Fashion 서비스 Create(생성), Read(읽기), Update(갱신), Delete(삭제) 권한 | 
