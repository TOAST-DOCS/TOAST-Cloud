...
| Infrastructure | NCS ADMIN | NHN Container Service(NCS) 서비스 Create(생성)/Read(읽기)/Update(갱신)/Delete(삭제)  |
| Infrastructure | NCS VIEWER | NHN Container Service(NCS) 서비스 Read(읽기)  |
