...
기술 지원은 조직 혹은 프로젝트 멤버와 함께 문의를 등록 및 관리할 수 있는 기능입니다.
등록한 문의는 같은 조직 혹은 프로젝트 내 모든 멤버가 확인할 수 있습니다. 필요한 경우 다른 멤버가 등록한 문의에 추가 질문을 남길 수 있습니다.
...
1. **문의 목록 화면**에서 **문의 접수** 버튼을 클릭합니다.
2. 접수하고자 하는 문의 유형을 선택하고 각 필드를 안내에 따라 작성합니다.
...
1. 문의 목록 화면의 **문의 목록** 테이블에서 추가 질문을 접수하고자 하는 **문의** 테이블 행을 클릭합니다.
2. **상세 문의** 내역 화면 하단의 **추가 질문** 접수 폼을 입력합니다.
3. **추가 질문** 접수 폼 내부의 **접수** 버튼을 클릭합니다.
    * 추가 질문 내용과 전화번호는 **필수값**입니다.
    * 회원 정보에 등록된 전화번호가 존재하는 경우 입력 필드에 기본값으로 채워집니다.

### 문의 답변 내용 확인

1. **문의 목록** 화면의 문의 목록 테이블에서 답변 내용을 확인하고자 하는 문의 테이블 행을 클릭합니다.
2. **상세 문의** 내역 화면에서 문의 내용, 추가 질문 내용, 답변 내용 을 확인할 수 있습니다.