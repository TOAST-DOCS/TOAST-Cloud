...
* [기본 인프라 서비스(Infrastructure)](../ko/overview.md#service-composition) 의 역할별 상세 권한은 [전체 권한 매트릭스 보기](../etc/infrastructure_roles_guide-gov.html){:target="_blank" rel="noopener"}을 참조하세요.
