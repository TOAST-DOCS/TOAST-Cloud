...
알림 수신 그룹 관리 기능은 NHN Cloud에서 발송되는 알림에 대한 수신 그룹을 설정할 수 있는 기능입니다.
역할에 의한 수신 그룹 설정 외에 조직/프로젝트 역할 기반의 수신 대상 설정 및 NHN Cloud 멤버(NHN Cloud 계정, IAM 계정)에 대한 수신 대상 직접 설정을 지원합니다.
웹훅 설정을 통해 기본 웹훅과 커스텀 웹훅을 제공합니다.
...
5. **수신 대상 직접 설정**
    ...
    - NHN Cloud 계정 또는 IAM 계정별 Email, SMS 알림 설정을 지원합니다.

6. **웹훅 설정**
    - 알림 발송시 사용자가 원하는 웹훅으로 설정할 수 있습니다.
...
3. **웹훅 추가** 팝업에서는 유형별로 기본 웹훅과 커스텀 웹훅을 제공합니다.
    - 기본 웹훅
        ...
        - 비밀 키
            - 사용 방식에 따라 SecretKey를 설정하여 기본 웹훅에 전송할 수 있습니다.
    - 커스텀 웹훅
        - 웹훅 이름
