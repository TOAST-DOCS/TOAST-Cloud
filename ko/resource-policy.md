...
| 트랜짓 허브 | 프로젝트당 | 10개 |
| 트랜짓 허브 연결 | 프로젝트당 | 20개 |
| 트랜짓 허브 허용 목록 | 프로젝트당 | 10개 |
| 트랜짓 허브 라우팅 테이블 | 프로젝트당 | 20개 |
| 트랜짓 허브 라우팅 연결 | 프로젝트당 | 제한 없음 |
| 트랜짓 허브 라우팅 전파 | 프로젝트당 | 제한 없음 |
| 트랜짓 허브 라우팅 룰 | 프로젝트당 | 100개 |
| 트랜짓 허브 멀티캐스트 도메인 | 프로젝트당 | 20개 |
| 트랜짓 허브 멀티캐스트 연 | 프로젝트당 | 제한 없음 |
| 트랜짓 허브 멀티캐스트 그룹 | 프로젝트당 | 100개 |
