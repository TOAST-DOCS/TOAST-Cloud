...
Compute & Network 서비스를 활성화해야만 사용할 수 있는 'RDS for MySQL, RDS for MS-SQL, EasyCache' 서비스도 정책이 적용됩니다.
...
### 리소스 제공량 증설 요청  
제공 정책의 사용량 증설을 원하는 경우 TOAST 고객 센터 [1:1문의](https://www.toast.com/kr/support/inquiry)로 문의하시면 됩니다. 
