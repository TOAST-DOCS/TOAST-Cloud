...
|VPN(Site-to-Site VPN) 연결| 서브넷당 | 1개 | X | |
...
| 친구톡 발송 건수 | 카카오톡 채널당 1일 | 5,000건 | O | | 
...
### AI Fashion 서비스 리소스 제공 정책
리소스 사용량은 프로젝트별로 계산됩니다.

| 리소스 | 제공 기준 | 기본 제공량 | 조정 가능 여부 | 최대 제공량 |
|----|----|----|----|----|
| AI Fashion 서비스 수 | 프로젝트 당 | 5개 | O | | 
| 최대 문서 수 | AI Fashion 서비스 당 | 100,000건 | O | |
| 색인 요청 문서 수	 | 색인 요청 당	 | 10,000건 | O | |
| 색인 입력 파일 크기 | 색인 요청 당 | 20MB | O | |
