...
|리소스 | 제공 기준 | 기본 제공량 | 조정 가능 여부 | 최대 제공량 |
|----|----|----|----|----|
| NAS for BigData 스토리지 | 프로젝트당 | 0개 | O | |
| NAS for BigData 스토리지 크기 | 프로젝트당 | 2PB | O | |
| NAS for BigData 스토리지 최대 크기 | NAS스토리지당 | 1PB | O | |
...
### 리소스 제공량 증설 요청  
제공 정책의 사용량 증설을 원하는 경우 고객 센터 [1:1문의](https://www.ngsc.go.kr/kr/support/inquiry)로 문의하시면 됩니다. 
