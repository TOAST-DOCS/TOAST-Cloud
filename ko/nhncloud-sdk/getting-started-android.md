...
| ------------------------------------------- | ----------------- |
| com.nhncloud.android:nhncloud-common:1.7.0       | Common      |
| com.nhncloud.android:nhncloud-core:1.7.0         | Core        |
| com.nhncloud.android:nhncloud-logger:1.7.0       | Log & Crash |
| com.nhncloud.android:nhncloud-crash-reporter-ndk:1.7.0       | Native Crash Reporter |
| com.nhncloud.android:nhncloud-iap-core:1.7.0     | In-app Purchase Core |
| com.nhncloud.android:nhncloud-iap-google:1.7.0   | In-app Purchase <br>Google Play Store |
| com.nhncloud.android:nhncloud-iap-onestore:1.7.0 | In-app Purchase <br>ONE store |
| com.nhncloud.android:nhncloud-iap-galaxy:1.7.0 | In-app Purchase <br>Galaxy Store |
| com.nhncloud.android:nhncloud-push-core:1.7.0    | Push Core   |
| com.nhncloud.android:nhncloud-push-fcm:1.7.0    | Push <br>Firebase Cloud Messaging |
| com.nhncloud.android:nhncloud-creditcard-recognizer:1.7.0    | Credit Card Recognizer |
...
dependencies {
  implementation 'com.nhncloud.android:nhncloud-sdk:1.7.0'
}
```
