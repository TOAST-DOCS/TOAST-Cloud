...
| 비밀번호| - 영문, 숫자, 특수문자를 포함하여 9자리 이상으로 구성합니다. <br/> - 이전과 동일한 비밀번호는 사용할 수 없습니다. <br/> - 대소문자를 구분합니다. <br/> - 4자리 이상 연속적인 문자나 숫자(예: 1111, 1234, adcd 등)는 사용 할 수 없습니다. <br/> - 비밀번호는 90일마다 변경해 주세요. 90일이 지나면 비밀번호 변경 안내 화면이 제공됩니다. | O |
...
| 신용카드(기명) | 휴대폰 본인 인증 | 카드 번호, 유효기간, 주민등록번호 앞 7자리 | 체크카드 지원 |
...
## 회원 탈퇴
### 회원 탈퇴 신청
NHN Cloud (공공기관용) 회원 탈퇴는 **마이 페이지> 회원 정보**에서 **회원 탈퇴** 버튼을 클릭하여 신청합니다.
