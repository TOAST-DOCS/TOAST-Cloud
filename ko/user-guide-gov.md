...
## NHN Cloud (공공기관용) > NHN Cloud (공공기관용) 사용 가이드
NHN이 만든 공공 클라우드 서비스, NHN Cloud (공공기관용) 이용 방법을 설명한 사용자 가이드입니다.

## NHN Cloud (공공기관용) 회원 가입
...
| 비밀번호| - 영문, 숫자, 특수문자를 포함하여 9자리 이상으로 구성합니다. <br/> - 이전과 동일한 비밀번호는 사용할 수 없습니다. <br/> - 대소문자를 구분합니다. <br/> - 비밀번호는 90일마다 변경해 주세요. 90일이 지나면 비밀번호 변경 안내 화면이 제공됩니다. | O |
