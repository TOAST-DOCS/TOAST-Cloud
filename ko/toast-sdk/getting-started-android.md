...
| ------------------------------------------- | ----------------- |
| com.toast.android:toast-common:0.23.0       | TOAST Common      |
| com.toast.android:toast-core:0.23.0         | TOAST Core        |
| com.toast.android:toast-logger:0.23.0       | TOAST Log & Crash |
| com.toast.android:toast-crash-reporter-ndk:0.23.0       | TOAST Native Crash Reporter |
| com.toast.android:toast-iap-core:0.23.0     | TOAST In-app Purchase Core |
| com.toast.android:toast-iap-google:0.23.0   | TOAST In-app Purchase <br>Google Play Store |
| com.toast.android:toast-iap-onestore:0.23.0 | TOAST In-app Purchase <br>OneStore |
| com.toast.android:toast-push-core:0.23.0    | TOAST Push Core   |
| com.toast.android:toast-push-fcm:0.23.0    | TOAST Push <br>Firebase Cloud Messaging |
| com.toast.android:toast-push-tencent:0.23.0    | TOAST Push <br>Tencent Push Notification |
...
```groovy
dependencies {
  implementation 'com.toast.android:toast-sdk:0.23.0'
}
```
