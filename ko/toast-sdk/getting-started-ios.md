## NHN Cloud > NHN Cloud SDK 사용 가이드 > 시작하기 > iOS
...
| Mandatory | NHN CloudCore<br>ToastCommon |  | ToastCore.framework<br>ToastCommon.framework |  | OTHER\_LDFLAGS = (<br>"-ObjC",<br>"-lc++"<br>); |
