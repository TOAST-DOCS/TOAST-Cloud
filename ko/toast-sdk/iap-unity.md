...
dependencies {
    ...
    implementation 'com.toast.android:toast-unity-iap-google:0.27.0'
**DEPS**}
```
...
dependencies {
	implementation fileTree(dir: 'libs', include: ['*.jar'])
    implementation 'com.toast.android:toast-unity-iap-onestore:0.27.0'
**DEPS**}
```
...
dependencies {
	implementation fileTree(dir: 'libs', include: ['*.jar'])
    implementation 'com.toast.android:toast-unity-iap-galaxy:0.27.0'
**DEPS**}
```
