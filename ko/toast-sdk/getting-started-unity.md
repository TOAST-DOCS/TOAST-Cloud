## NHN Cloud > NHN Cloud SDK 사용 가이드 > 시작하기 > Unity
...
|---|---|---|
| NHN Cloud | NHN Cloud SDK의 루트 폴더 | All |
| NHN Cloud/Common | NHN Cloud SDK의 공통 모듈 폴더 | All |
| NHN Cloud/Logger | NHN Cloud Logger 모듈 폴더 | Logger, Sample |
| NHN Cloud/IAP | NHN Cloud IAP 모듈 폴더 | IAP, Sample |
| NHN Cloud/Sample | SDK 샘플 폴더 | Sample |
...
2. **File > Build Settings**에서 NHN Cloud/Sample/Sample.unity를 **Scenes In Build**에 추가합니다.
...
NHN CloudLogger의 로그 전송 API를 호출할 때마다 설정한 사용자 아이디를 로그와 함께 서버로 전송합니다.
...
* [NHN Cloud Log & Crash](./log-collector-unity) 사용 가이드
* [NHN Cloud IAP](./iap-unity) 사용 가이드
