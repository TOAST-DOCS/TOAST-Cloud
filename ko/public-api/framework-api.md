...
### 개요
- 관리자를 위한 프레임워크 관련 API
- 이 API들을 통해 프로젝트 멤버를 생성하거나 역할을 부여하는 등 조직과 프로젝트를 관리하는 데 필요한 API들을 사용해 주실 수 있습니다.
- API 사용을 위해선 우선 [API 인증](https://docs.nhncloud.com/ko/nhncloud/ko/public-api/api-authentication)을 통해 발급받은 Bearer 타입의 토큰이 필요합니다.
...
| Name | Type | Required | Description | 
|------------ | ------------- | --------- | ------------ |
|   **memberStatuses** | **List&lt;String>**| **No** | 조회할 멤버의 상태<br><ul><li>STABLE : 초대 완료</li><li>INVITED : 초대 중</li><li>BLOCKED</li><li>NOT_EXIST</li><li>WITHDRAW</li></ul> |
