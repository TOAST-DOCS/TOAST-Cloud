...
![C_project_API security_ko](http://static.toastoven.net/toast/public_api/C_project_API security_ko.png)

3. **Appkey 생성** 모달 창에서 **Appkey 이름** 입력 필드에 생성할 프로젝트 통합 Appkey의 이름을 입력한 뒤 **확인**을 클릭합니다.
![C_project_API security_2_ko](http://static.toastoven.net/toast/public_api/C_project_API security_2_ko.png)
