...
!!! tip "알아두기"
    ...
    * 프레임워크 API, 파트너 관리 API, 각 서비스마다 지원하는 API 인증 방식이 다르며, 일부 인증 방식은 특정 서비스에서만 지원합니다. 각 Public API별 지원되는 인증 방식은 [인증 방식 지원 현황](https://docs.{% if "gov" in build_flags %}gov-{% endif %}nhncloud.com/ko/nhncloud/ko/public-api/supported-authentication-methods)에서 확인할 수 있습니다.

<a id="getting-started-with-public-api"></a>
## Public API 시작하기 { #getting-started-with-public-api }

* [인증 방식 개요](https://docs.{% if "gov" in build_flags %}gov-{% endif %}nhncloud.com/ko/nhncloud/ko/public-api/auth-method-overview)
* [인증 방식 지원 현황](https://docs.{% if "gov" in build_flags %}gov-{% endif %}nhncloud.com/ko/nhncloud/ko/public-api/supported-authentication-methods)
* [서비스 API](https://docs.{% if "gov" in build_flags %}gov-{% endif %}nhncloud.com/ko/nhncloud/ko/public-api/service-api)
* [프레임워크 API](https://docs.{% if "gov" in build_flags %}gov-{% endif %}nhncloud.com/ko/nhncloud/ko/public-api/framework-api/)
* [파트너 관리 API](https://docs.{% if "gov" in build_flags %}gov-{% endif %}nhncloud.com/ko/nhncloud/ko/public-api/partner-api/)
* [릴리스 노트](https://docs.{% if "gov" in build_flags %}gov-{% endif %}nhncloud.com/ko/nhncloud/ko/public-api/release-notes/)
