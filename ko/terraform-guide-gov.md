...
provider 버전은 [Terraform Registry](https://registry.terraform.io/providers/nhn-cloud/nhncloud/latest)의 `VERSION` 정보를 참고하여 작성합니다.
...
> [참고]
> NHN Cloud가 제공하는 NKS 클러스터 애드온 상세 목록은 API 가이드의 [NHN Cloud에서 제공하는 애드온 목록 보기](/Container/NKS/ko/public-api-gov/#view-a-list-of-add-ons-offered-by-nhn-cloud) 및 사용 가이드의 [애드온 목록](/Container/NKS/ko/user-guide-gov#addon-mgmt-addon-list) 항목을 참고하세요.
