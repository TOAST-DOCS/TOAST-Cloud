...
## 포트 추가/허용 신청 절차
- 1. 아래 이미지 링크를 통해 “TOASTCloud G 방화벽 및 SSL VPN 정책 신청서.xlsx” 파일 다운로드 및 작성
<center>
...
- 2.작성파일명 “TOASTCloud G 방화벽 및 SSL VPN 정책 신청서_기관명.xlsx”으로 저장 <br>
- 3.TOAST G 대표 메일 support@gov-cloud.toast.com로 접수 신청 메일 발송 (접수일 기준으로 3일 이내 처리 및 회신)<br>
