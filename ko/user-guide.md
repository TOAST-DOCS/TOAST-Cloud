...
| 비밀번호| - 영문, 숫자, 특수문자를 포함하여 8자리 이상으로 구성합니다. <br/> - 이전과 동일한 비밀번호는 사용할 수 없습니다. <br/> - 대소문자를 구분합니다. <br/> - 4자리 이상 연속적인 문자나 숫자(예: 1111, 1234, adcd 등)는 사용 할 수 없습니다. <br/> - 비밀번호는 90일마다 변경해 주세요. 90일이 지나면 비밀번호 변경 안내 화면이 제공됩니다. | O |
