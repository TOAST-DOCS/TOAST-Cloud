...
- 신용카드 : 카드사에서 제공하는 인증 정책에 따라 인증(공인인증서 인증)을 하고, 신용카드를 결제수단으로 등록합니다. -- 추후 제공 예정 <br/>
- 신용카드(해외) : 카드사에서 제공하는 인증 정책에 따라 인증(3D인증)을 하고, 신용카드를 결제수단으로 등록합니다. <br/>
- 계좌이체 : 사업자회원에만 제공되는 결제 수단으로, 법인 계좌를 입력하고 은행 정책에 따라 인증(법인공인인증서 인증) 후 결제수단으로 등록합니다. <br/>
...
| 사업자 | PAYCO 신용카드 | 사업자등록번호 | 카드번호, 유효기간, 사업자등록번호 | |
|  | 신용카드(기명) | 휴대폰 본인인증 | 카드번호, 유효기간, 비밀번호 앞 2자리 | |
|  | 신용카드(무기명) | 사업자등록번호 | 카드번호, 유효기간, 비밀번호 앞 2자리 | |
|  | 계좌이체 | 법인 공인인증서 인증 | 은행, 계좌번호 | 회원과 동일한 사업자정보의 법인계좌와 공인인증서 필요 |
...
- 개인 / 기명 법인카드
    - 휴대폰 본인 인증
      - 이름, 성별, 생년월일, 휴대폰 번호를 입력하여 본인인증을 진행합니다.
    - 카드 정보 입력
      - 카드번호, 카드유효기간, 생년월일을 입력한 후 결제수단을 등록합니다.
- 무기명 법인카드
    - 사업자등록번호를 입력합니다.
...
#### 법인 공인인증서 인증
- 법인 계좌의 사업자정보와 동일한 사업자정보로 등록된 공인 인증서를 선택하여 인증합니다.
