...
2\. [TOAST 콘솔](https://console.cloud.toast.com)에서 [Notification \> Push를 활성화](http://docs.toast.com/en/Notification/Push/en/console-guide/)합니다.
...
알림 메세지에 미디어(이미지, 비디오, 오디오)와 버튼을 표현하기 위해서는 어플리케이션에 [Notification Service Extension](/TOAST/en/toast-sdk/push-ios/#notification-service-extension) 이 추가되어 있어야만 합니다.
...
수신 지표 수집을 위해서는 어플리케이션에 [Notification Service Extension](/TOAST/en/toast-sdk/push-ios/#notification-service-extension) 이 추가되어 있어야만 합니다.
...
[Toast Push SDK 초기화](/TOAST/en/toast-sdk/push-ios/#toast-push-sdk) 혹은 `Application의 info.plist 파일` 내부에 앱키를 설정하셔야만 지표 전송이 가능합니다.
