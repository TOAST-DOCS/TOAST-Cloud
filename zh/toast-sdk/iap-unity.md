...
dependencies {
    ...
    implementation 'com.toast.android:toast-unity-iap-google:0.24.3'
**DEPS**}
```
...
dependencies {
	implementation fileTree(dir: 'libs', include: ['*.jar'])
    implementation 'com.toast.android:toast-unity-iap-onestore:0.24.3'
**DEPS**}
```
...
dependencies {
	implementation fileTree(dir: 'libs', include: ['*.jar'])
    implementation 'com.toast.android:toast-unity-iap-galaxy:0.24.3'
**DEPS**}
```
