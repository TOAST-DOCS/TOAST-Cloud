## NHN Cloud > User Guide for NHN Cloud SDK > NHN Cloud IAP > Unity

## Prerequisites

1. [Install the NHN Cloud SDK](./getting-started-unity)
2. [NHN Cloud 콘솔](https://console.cloud.toast.com)에서 [Mobile Service \> IAP를 활성화](https://docs.toast.com/zh/Mobile%20Service/IAP/zh/console-guide/)합니다.
...
[NHN CloudIapConfiguration](./iap-unity/#toastiapconfiguration)을 이용해서 NHN Cloud IAP 콘솔에서 발급받은 AppKey와 스토어 코드([StoreCode](./iap-unity/#storecode))를 설정합니다.
